            ...
            <div class="col-xl-10 col-lg-12 col-md-9">
                ...
                <div class="card o-hidden border-0 shadow-lg my-5">
                    <div class="card-body p-0">
                        ...
                        <div class="row">
                            <div class="col-lg-6 d-none d-lg-block bg-login-image" bg-login-image="<?php echo base_url('')?>"></div>
                            <div class="col-lg-6">
                                <div class="p-5">
                                    ...
                                    <form action="<?php echo base_url('/'); ?>" method="post">
                                        ...
                                        <div class="form-group">
                                            <input type="text" name="member_username" value="<?php echo session()->getFlashdata('member_username');?>" class="form-control form-control-user"
                                                id="inputUsername" aria-describedby="emailHelp"
                                                placeholder="Masukkan Username...">
                                        </div>
                                        <div class="form-group">
                                            <input type="password" name="member_password" class="form-control form-control-user"
