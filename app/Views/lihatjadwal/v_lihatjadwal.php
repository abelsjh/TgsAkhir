                        ...
                        <div class="col-lg-9 mb-4">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h6 class="m-0 font-weight-bold text-primary">Jadwal Ibadah</h6>
                                </div>
                                        ...
                                        <table class="table table-bordered">
                                            ...
                                            <tbody>
                                                ...
                                                foreach ($jadwal as $row) : ?>
                                                    <tr>
                                                        <td><?= $no++; ?></td>
                                                        <td><?= $row['nama_ibadah']; ?></a></td>
                                                    </tr>
                                                <?php endforeach; ?>
                                            </tbody>
                                        </table>
                                    </div>
                                    <div class="text-right"><a href="<?php echo base_url('details-jadwal') ?>">Lihat Selengkapnya</div>
                                </div>
                            </div>
                        </div>
                    </div>
