            ...
            <div id="content">
                ...
                <div class="container-fluid">
                    ...
                    <div class="d-sm-flex align-items-center justify-content-between mb-4">
                        <h1 class="h3 mb-0 text-gray-800">Buat Pelayanan Ibadah</h1>
                    </div>
                        ...
                        <div class="col-lg-9 mb-4">
                            <div class="card shadow mb-4">
                                <div class="card-header py-3">
                                    <h5 class="m-0 font-weight-bold">Masukkan Parameter Penjadwalan</h5>
                                    <hr>
                                    <div class="row">
                                        <div class="col-lg-9 mb-4">
                                            <div class="card shadow mb-4">
                                                <div class="card-header py-3">
                                                    <h5 class="m-0 font-weight-bold">Form Jadwal Ibadah</h5>
                                                </div>
                                                <div class="card-body">
                                                    <form action="<?php echo base_url('submit-jadwal'); ?>" method="post">
                                                        ...
                                                        <div class="form-group">
                                                            ...
                                                            <select class="form-control" id="nama_ibadah" name="nama_ibadah" required>
                                                                <option value="" disabled selected>Pilih Ibadah</option>
                                                                <option value="Kebaktian Sekolah Minggu">Sekolah Minggu</option>
                                                                <option value="Kebaktian Ibadah Umum Pagi & Sore">Kebaktian Umum</option>
                                                            </select>
                                                        </div>
                                                        <div class="form-group">
                                                            <label for="tim">Tim yang Bertugas</label>
                                                            <select class="form-control" id="tim_ibadah" name="tim_ibadah" required>
